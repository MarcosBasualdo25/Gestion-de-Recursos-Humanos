...
int main() {
    ...
    while (true) {
        ...
        if (rol == "ADMINISTRADOR") {
            string opciones[] = {"1. Gestión de empleados", "2. Evaluación de empleados","3. Solicitudes", "4. Gestion de Proyectos","5. Volver a iniciar sesion","6. Salir"};   
            int n = 6;
            ...
            string opciones[] = {"1. Evaluación de empleado", "2. Asistencia de empleado","3. Solicitudes","4. Volver a iniciar sesion","5. Salir"};
            int n = 5;
            opc = menu(titulo, opciones, n);
            switch (opc) {
                case 1: {
